        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    pets_found_home_count = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    pets_looking_forHome_count = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    pets_on_treatment_count = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    work_experience = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    residential_address = table.Column<string>(type: "character varying(370)", maxLength: 370, nullable: false),
                    phone_number = table.Column<string>(type: "char(11)", nullable: false),
